...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (srchVal=="") return;
        OleDbConnection conn = new OleDbConnection(SqlDataSource1.ConnectionString);
        OleDbCommand cmd = new OleDbCommand("select contactName,fld1,fld2,fld3,fld4 from tblPhones where orgID=1 and contactName like '%" + srchVal + "%'", conn);
        cmd.CommandType = CommandType.Text;
        OleDbDataReader dr;
        ...
        { 
            ...
            //TextBox1.Text = dr["fld1"].ToString();
            //TextBox2.Text = dr["fld2"].ToString();
            //TextBox3.Text = dr["fld3"].ToString();
            //TextBox4.Text = dr["fld4"].ToString();
