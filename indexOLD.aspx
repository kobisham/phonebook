<%@ Page Language="C#" AutoEventWireup="true" CodeFile="indexOLD.aspx.cs" Inherits="_Default" %>
        ...
        <header>
            <table class="tblHeader">
                <tr>
                    ...
                    <td class="tdHeaderLeft" onclick="window.location.href='index.aspx';">
                            ...
                            <table class="tblResults">
                                ...
                                <tr >
                                    ...
                                    <td style="text-align:left;padding-bottom: 10px">
                                        ...
                                        <a target="_blank" id="aFld3" href="javascript:void(0);" runat="server">
                                            <asp:Image ID="img3_err"  runat="server" ImageUrl="~/images/edit.png"  Width="48" Height="48" CssClass="imgErr" />
                                        ...
                                        <!-- CellPhone -->
                                         ...
                                         <a target="_blank" id="aFld4" href="javascript:void(0);" runat="server">
                                            
                                            <asp:Image ID="img4_err"  runat="server" ImageUrl="~/images/edit.png"  Width="48" Height="48" />
